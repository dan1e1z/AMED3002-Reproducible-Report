...
- Differential expression analysis of protein-coding genes was performed using EdgeR with the same criteria as the original study (P < 0.05, |fold change| ≥ 1.5), yielding 2,162 differentially expressed mRNAs consistent with the reported total.
